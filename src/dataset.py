...
class PaperImplementationsDataset(Dataset):
    """Dataset for paper implementations."""
...
def get_dataloader(root, split, config):
    ...
    dataset = PaperImplementationsDataset(root, split, transform)
    return DataLoader(
        dataset,
